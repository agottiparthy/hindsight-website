...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "vs. Clozd", href: "/compare/hindsight-vs-clozd" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Ironclad", href: "/results/ironclad" },
      { label: "LaunchDarkly", href: "/results/launchdarkly" },
      { label: "PurpleLab", href: "/results/purplelab" },
      { label: "Simpro", href: "/results/simpro" },
