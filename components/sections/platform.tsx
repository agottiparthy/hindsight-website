        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#11214C] mb-6">
              Competitive intel and win-loss, simplified.
            </h2>
            <p className="text-lg text-[#11214C]/70">
              Hindsight is a system of record for what&apos;s driving wins and losses. It analyzes every deal, identifies what&apos;s actionable, and keeps your messaging, enablement, and reporting aligned.
            </p>
          </div>
